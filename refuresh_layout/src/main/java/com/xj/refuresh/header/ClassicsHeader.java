...
import com.xj.refuresh.internal.ArrowDrawable;
import com.xj.refuresh.internal.InternalClassics;
import com.xj.refuresh.internal.ProgressDrawable;
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        updateView.setTag(ID_TEXT_UPDATE);
