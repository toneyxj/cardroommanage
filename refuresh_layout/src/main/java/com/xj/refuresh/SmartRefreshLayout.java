...
import com.xj.refuresh.api.DefaultRefreshInitializer;
import com.xj.refuresh.api.RefreshContent;
...
import com.xj.refuresh.api.ScrollBoundaryDecider;
import com.xj.refuresh.constant.DimensionStatus;
import com.xj.refuresh.constant.RefreshState;
import com.xj.refuresh.constant.SpinnerStyle;
import com.xj.refuresh.footer.BallPulseFooter;
import com.xj.refuresh.header.BezierRadarHeader;
import com.xj.refuresh.impl.RefreshContentWrapper;
import com.xj.refuresh.impl.RefreshFooterWrapper;
import com.xj.refuresh.impl.RefreshHeaderWrapper;
import com.xj.refuresh.listener.OnLoadMoreListener;
import com.xj.refuresh.listener.OnMultiPurposeListener;
import com.xj.refuresh.listener.OnRefreshListener;
import com.xj.refuresh.listener.OnRefreshLoadMoreListener;
import com.xj.refuresh.listener.OnStateChangedListener;
import com.xj.refuresh.util.DelayedRunnable;
import com.xj.refuresh.util.DensityUtil;
import com.xj.refuresh.util.SmartUtil;
import com.xj.refuresh.util.ViscousFluidInterpolator;
...
import static com.xj.refuresh.util.DensityUtil.dp2px;
...
//    }
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.xj.refuresh.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.xj.refuresh.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
